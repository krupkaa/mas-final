...
@Route("showEmployees")
public class ShowClientsView extends VerticalLayout {

    Grid<String[]> grid = new Grid<>();

    public ShowClientsView() {
        Button buttonReadFile = new Button("Wyświetl wszystkich pracowników",  e -> readFromClasspath());
        add(buttonReadFile, grid);
    }

    private void readFromClasspath() {
        displayCsv(getClass().getClassLoader().getResourceAsStream("employees.csv"));
    }
